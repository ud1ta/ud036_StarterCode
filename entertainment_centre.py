...
blade_runner = media.Movie("Blade Runner",
                           ...
                           "https://images-na.ssl-images-amazon.com/images/M/MV5BNzQzMzJhZTEtOWM4NS00MTdhLTg0YjgtMjM4MDRkZjUwZDBlXkEyXkFqcGdeQXVyNjU0OTQ0OTY@._V1_QL50_SY1000_CR0,0,671,1000_AL_.jpg",  # noqa
...
ftkmf = media.Movie("First They Killed My Father",
                    ...
                    "https://images-na.ssl-images-amazon.com/images/M/MV5BMTgzOTQ1NDUwOF5BMl5BanBnXkFtZTgwNjAwNTkwMzI@._V1_QL50_SY1000_CR0,0,674,1000_AL_.jpg",  # noqa
...
dunkirk = media.Movie("Dunkirk",
                      # "When 400,000 men couldn't get home...Home came for them",  # noqa
                      "https://images-na.ssl-images-amazon.com/images/M/MV5BN2YyZjQ0NTEtNzU5MS00NGZkLTg0MTEtYzJmMWY3MWRhZjM2XkEyXkFqcGdeQXVyMDA4NzMyOA@@._V1_QL50_SY1000_CR0,0,674,1000_AL_.jpg",  # noqa
                      "https://www.youtube.com/watch?v=T7O7BtBnsG4")

# Movie object for Into the Wild
supertramp = media.Movie("Into the Wild",
                         # "Go with your heart",
                         "https://images-na.ssl-images-amazon.com/images/M/MV5BMTAwNDEyODU1MjheQTJeQWpwZ15BbWU2MDc3NDQwNw@@._V1_QL50_.jpg",  # noqa
                         "https://www.youtube.com/watch?v=g7ArZ7VD-QQ")


# List of all the movie objects used by the open_movies_page method
# in the fresh_tomatoes module
movies = [aso_2001, blade_runner, ftkmf,
          blade_runner_2049, dunkirk, supertramp]
